...
alias eol='cd ~/eol'
alias vag='cd ~/vagrant_eol; vagrant ssh'
...
# Edit aliases:
alias ealias='homesick cd dotfiles ; homesick pull dotfiles ; vim home/.bash_aliases ; homesick commit dotfiles ; homesick push dotfiles ; exit ; source ~/.bash_aliases'
